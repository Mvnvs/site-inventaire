<!DOCTYPE html>
    ...
    <body class="bg-gray-100 w-screen">
        <main>
            <div class="bg-white">
                <div class="mx-auto max-w-7xl py-10 px-4 sm:py-12 sm:px-7 lg:px-2">
                    <div class="relative text-center">
                        <h2 class="text-lg font-semibold text-indigo-600">Lorem.</h2>
                        <p class="mt-1 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">Lorem ipsum dolor sit amet.</p>
                        <p class="mx-auto mt-5 max-w-xl text-xl text-gray-500">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sapiente magni pariatur illo unde possimus assumenda consequuntur quam.</p>
                    </div>
                </div>
            </div>
        </main>
        <a href="#"><img class="object-contain h-auto w-screen" src="banner.jpg"></a>
        <div class="bg-white">
    ...
    <footer class="bg-white">
      <div class="mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
        <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          ...
          <div class="px-5 py-2">
            <a href="aboutus.html" class="text-base text-gray-500 hover:text-gray-900">About us</a>
          </div>
        </nav>
