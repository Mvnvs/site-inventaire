...
<head>
    ...
    <body >
        <div id="body">
            <h1 class="font-bold">Login with email</h1>
            <div id="account">
            ...
            <form method="post">
                ...
                <input type="submit" name="formsend2" id="formsend2" value="Log in">
            </form>
                 <?php
                     if(isset($_POST['formsend2'])){
                         ...
                         if(!empty($cemail) && !empty($password)){
                             ...
                             global $db;
                             $mysql = $db->prepare("SELECT * FROM utilisateur WHERE email = :email");
                             $mysql->execute(['email' => $cemail]);
                             $result = $mysql->fetch();
                             if($result == true){
                                 ...
                                 echo "Email :" . $cemail . " doesn't exist";
                             }
                         }
                         else{
                             echo "Please put an email and a password ";
                         }
                     }
                ?>
        </div>
